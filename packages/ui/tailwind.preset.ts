  ...
  theme: {
    extend: {
      ...
      spacing: {
        ...
        10: "var(--sg-space-10)",
        12: "var(--sg-space-12)",
        "sg-size-toolbar-height": "var(--sg-size-toolbar-height)",
        "sg-size-panel-header-height": "var(--sg-size-panel-header-height)",
        "sg-size-channel-rack-strip-height": "var(--sg-size-channel-rack-strip-height)",
        "sg-size-mixer-strip-width": "var(--sg-size-mixer-strip-width)",
        "sg-size-fader-width": "var(--sg-size-fader-width)",
        "sg-size-button-height": "var(--sg-size-button-height)",
        "sg-size-button-small-height": "var(--sg-size-button-small-height)",
        "sg-size-input-height": "var(--sg-size-input-height)",
        "sg-size-ruler-height": "var(--sg-size-ruler-height)",
      },
      borderRadius: {
        sm: "var(--sg-radius-sm)",
        md: "var(--sg-radius-md)",
